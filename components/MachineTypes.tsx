  ...
  return (
    <section className="px-6 py-16">
      <div className="mx-auto max-w-5xl">
        ...
        <div className="mt-12 border-t border-ink-900/15">
          {types.map((t, i) => (
            <motion.a
              key={t.name}
              href="#"
              ...
              className="group grid grid-cols-12 items-center gap-6 border-b border-ink-900/15 py-6"
            >
              <div className="col-span-1 kicker text-ink-900/50">0{i + 1}</div>
              <div className="col-span-11 sm:col-span-4 lg:col-span-3">
                <h3 className="display text-lg text-ink-900 sm:text-xl">{t.name}</h3>
                <div className="kicker mt-1">{t.en}</div>
              </div>
              <p className="col-span-12 text-xs leading-6 text-ink-900/70 sm:col-span-5 lg:col-span-5">
                {t.desc}
              </p>
              <div className="col-span-6 sm:col-span-2 lg:col-span-2">
                <div className="kicker">سرعت</div>
                <div className="mt-1 text-sm text-ink-900">
                  {t.speed} <span className="text-[10px] text-ink-900/50">spm</span>
                </div>
              </div>
